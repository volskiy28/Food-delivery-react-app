    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]">
        ...
        <input
          ...
          className="bg-transparent p-2 rounded-full outline-none w-full"
        />
      </div>
      ...
      <div
        className={
          nav
            ? "bg-black/80 fixed w-full h-screen z-10 top-0 left-0 duration-1000"
            : "bg-black/80 fixed w-full h-screen z-10 top-0 left-[-100%] duration-1000"
        }
      ></div>
